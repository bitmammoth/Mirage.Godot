...
namespace Mirage
{
    ...
    /// <para>
    /// If you dont need RPC or SyncVar use <see cref="NetworkBehaviour"/> instead
    /// </para>
    /// </summary>
    public abstract partial class NetworkBehaviour : Node
    {
        ...
        [Export] public double Interval = SyncSettings.Default.Interval;
        ...
        public void InitSyncObject(ISyncObject syncObject)
        {

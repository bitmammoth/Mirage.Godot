...
namespace Mirage
{
    ...
    public struct NetworkBehaviourSyncVar : IEquatable<NetworkBehaviourSyncVar>
    {
        ...
        public NetworkBehaviourSyncVar(NetworkBehaviour behaviour) : this()
        {
        ...
        public static implicit operator NetworkBehaviourSyncVar(NetworkBehaviour behaviour) => new NetworkBehaviourSyncVar(behaviour);
    }

    public struct NetworkBehaviorSyncvar<T> : IEquatable<NetworkBehaviorSyncvar<T>>, IEquatable<NetworkBehaviourSyncVar> where T : NetworkBehaviour
    {
        private NetworkBehaviourSyncVar inner;

        public NetworkBehaviorSyncvar(T behaviour) : this()
        {
            inner = new NetworkBehaviourSyncVar(behaviour);
        }
        ...
        public static implicit operator NetworkBehaviourSyncVar(NetworkBehaviorSyncvar<T> generic) => generic.inner;
        public static explicit operator NetworkBehaviorSyncvar<T>(NetworkBehaviourSyncVar syncvar) => new NetworkBehaviorSyncvar<T>() { inner = syncvar };
    ...
    {
        public static void WriteNetworkBehaviorSyncVar(this NetworkWriter writer, NetworkBehaviourSyncVar id)
        {
        ...
        public static NetworkBehaviourSyncVar ReadNetworkBehaviourSyncVar(this NetworkReader reader)
        {
            ...
            return new NetworkBehaviourSyncVar
            {

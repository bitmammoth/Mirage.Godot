    ...
    public static class Extensions
    {
        ...
        public static void SetConst<T>(this TypeDefinition td, string fieldName, T value) where T : struct
        {
            ...
            if (field == null)
            {
                ...
                const FieldAttributes fieldAttributes = FieldAttributes.Literal | FieldAttributes.HasDefault | FieldAttributes.Static | FieldAttributes.NotSerialized | FieldAttributes.Private;
                field = new FieldDefinition(fieldName, fieldAttributes, td.Module.ImportReference<T>());
                td.Fields.Add(field);
            }
        ...
        /// <summary>
        /// Makes a field part of generic definition
        /// <para>

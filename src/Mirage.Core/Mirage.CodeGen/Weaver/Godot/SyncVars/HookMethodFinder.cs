...
internal static class HookMethodFinder
{
    ...
    {
        var syncVarAttr = syncVar.GetCustomAttribute<SyncVarAttribute>() ?? throw new InvalidOperationException("FoundSyncVar did not have a SyncVarAttribute");
        ...
        var hookType = syncVarAttr.GetField(nameof(SyncVarAttribute.HookType), SyncHookType.Automatic);

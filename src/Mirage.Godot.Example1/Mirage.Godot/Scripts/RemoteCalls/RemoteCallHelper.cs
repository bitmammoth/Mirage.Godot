...
namespace Mirage.Godot.Scripts.RemoteCalls;
...
/// </summary>
public class RemoteCall(INetworkNode behaviour, RpcInvokeType invokeType, RpcDelegate function, bool requireAuthority, string name)
{
    /// <summary>
    ...
    /// </summary>
    public readonly RpcInvokeType InvokeType = invokeType;
    /// <summary>
    /// Function to be invoked when receiving message
    /// </summary>
    public readonly RpcDelegate Function = function;
    /// <summary>
    /// Used by ServerRpc
    /// </summary>
    public readonly bool RequireAuthority = requireAuthority;
    /// <summary>
    /// User friendly name
    /// </summary>
    public readonly string Name = name;

    public readonly INetworkNode Behaviour = behaviour;

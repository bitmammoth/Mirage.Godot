...
namespace Mirage.Godot.Scripts.Events
{
    /// <summary>
    ...
    {
        private List<Action> _tmp = [];
        public List<Action> _event = [];
    ...
    {
        private List<Action<T0>> _tmp = [];
        public List<Action<T0>> _event = [];
    ...
    {
        private List<Action<T0, T1>> _tmp = [];
        public List<Action<T0, T1>> _event = [];

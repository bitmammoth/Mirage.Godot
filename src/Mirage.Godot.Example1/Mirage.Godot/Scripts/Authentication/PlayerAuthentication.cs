...
public class PlayerAuthentication(INetworkAuthenticator authenticator, object data)
{
    /// <summary>
    /// What Authenticator was used to accept this player
    /// <para>Null if no Authenticator existed on Server</para>
    /// </summary>
    public readonly INetworkAuthenticator Authenticator = authenticator;
    ...
    private static readonly HashSet<IAuthenticationDataWrapper> antiInfiniteLoop = [];

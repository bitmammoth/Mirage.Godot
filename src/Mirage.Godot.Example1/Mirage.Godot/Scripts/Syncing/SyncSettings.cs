...
public struct SyncSettings(SyncFrom from, SyncTo to, SyncTiming timing, float interval)
{
    ...
    [FieldOffset(0)]
    public SyncFrom From = from;
    [FieldOffset(1)]
    public SyncTo To = to;
    [FieldOffset(2)]
    public SyncTiming Timing = timing;
    [FieldOffset(4)]
    ...
    public static bool ShouldSyncFromDefault(NetworkIdentity identity)
    {
        return identity.IsServer;
    }

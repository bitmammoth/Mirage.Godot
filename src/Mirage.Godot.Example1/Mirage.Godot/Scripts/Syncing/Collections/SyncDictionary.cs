...
public class SyncIDictionary<TKey, TValue>(IDictionary<TKey, TValue> objects) : IDictionary<TKey, TValue>, ISyncObject, IReadOnlyDictionary<TKey, TValue>
{
    protected readonly IDictionary<TKey, TValue> objects = objects;

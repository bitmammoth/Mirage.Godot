...
public static class StringExtensions
{
    ...
    public static void WriteString(this NetworkWriter writer, string value) => writer.WriteString(value, defaultEncoding);

    /// <returns>string or null</returns>
    /// <exception cref="ArgumentException">Throws if invalid utf8 string is received</exception>
    public static string ReadString(this NetworkReader reader) => reader.ReadString(defaultEncoding);

...
public class BitCountAttribute(int bitCount) : Attribute
{
}
...
[AttributeUsage(AttributeTargets.Field | AttributeTargets.Parameter)]
public class BitCountFromRangeAttribute(int min, int max) : Attribute
{
}
...
///
/// </summary>
public class QuaternionPackAttribute(int bitPerElement = 9) : Attribute
{
}
...
[AttributeUsage(AttributeTargets.Field | AttributeTargets.Parameter)]
public class VarIntBlocksAttribute(int blockSize) : Attribute
{
}
